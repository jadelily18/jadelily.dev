...
<Dialog.Root bind:open>
	...
	<Dialog.Content
		...
		class="fixed border-none bg-transparent! left-1/2 top-1/2 z-50 flex h-screen w-screen max-w-max! -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-noneshadow-2xl outline-none data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
	>
		<Dialog.Close
		...
		<div class="flex flex-col items-center px-6 py-4 sm:px-8">
			...
			<a
				class="inline-flex items-center gap-1 mt-2 mb-4 text-sm hover:underline text-white hover:text-lavender-pink-400 dark:hover:text-lilac-bush-400"
